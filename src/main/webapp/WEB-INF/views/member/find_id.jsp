...
<div class="content">
	<div class="member_wrapper">
		<h1 class="member_page_title">아이디 찾기</h1>
		<p class="member_page_subTitle">
			회원가입때 등록한 정보를 입력해 주세요.
		</p>
		<!-- 전화번호로 찾기 -->
		<form action="${pageContext.request.contextPath}/member/find_idPro" id="form" class="find_form" name="findform">
			<p class="f_f_box">
			...
			<input type="submit" id="find" class="find_btn" value="아이디 찾기" >
			<div class="f_f_box2">
				<p>
					아이디가 기억이 난다면 ▶
				...
				<p>
					비밀번호가 기억이 나지않는다면 ▶
					<a href="${pageContext.request.contextPath}/member/findPass">비밀번호 찾기 페이지 이동하기</a>
				</p>
			</div>
		</form>
		<!-- 이메일로 찾기 -->
