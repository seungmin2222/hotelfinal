...
<div class="content">
   <div class="sub_wrapper">
      <div class="reservation_box">
         <form  style="margin : 0 285px; " name="reservationForm" class="reserv_l_box" action="${pageContext.request.contextPath}/sub/reservationPro" method="post">
...
<!--          <div style="background: red;" class="reserv_r_box"> -->
