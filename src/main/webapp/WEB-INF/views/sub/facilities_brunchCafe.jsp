	...
	<div class="sub_wrapper">
		<div class="sub_rf_detail" >
			<div class="sub_rf_main_img">
				<img alt="room_image" src="${pageContext.request.contextPath}/resources/images/facilities_brunchCafe.jpg">
			</div>
			<h2>ROOM FEATURE</h2>
			<div class="sub_rf_info">
				...
				<dl class="sub_rf_i_dl">
					...
					<dd>
						● 주중<br>
						MON(월) ~ FRI(금) : 10:00 ~ 20:30<br>
						LST ORDER : 식사 ~ 18:00 / 그외 ~ 19:30
					</dd>
					<dd>
						● 주말<br>
						SAT(토) ~ SUN(일) : 10:00 ~ 21:00<br>
						LAST ORDER : 식사 ~ 18:00 / 그외 ~ 20:00
					</dd>
				</dl>
			</div>
		</div>
		<div class="sun_btn"><a href="<%=request.getContextPath() %>/sub/facilities">LIST</a></div>
	</div>
</div>
<!-- //body -->
